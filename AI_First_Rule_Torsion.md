...
$$\mathcal{I}_T = a_1 T^\rho{}_{\mu\nu}T_\rho{}^{\mu\nu} + a_2 T^\rho{}_{\mu\nu}T^{\mu\nu}{}_\rho + a_3 T_\mu T^\mu$$
...
1. Microscopic tetrad fluctuations
2. Torsional degrees of freedom
3. Curvature emergence
4. Macroscopic spacetime geometry
